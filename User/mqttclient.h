...
#if    LWIP_DNS
#define   HOST_NAME       "su6z4bh.mqtt.iot.gz.baidubce.com"     //服务器域名
#else
...
#define   USER_NAME     "su6z4bh/stm32f429"     //用户名
#define   PASSWORD      "Z8N0ZAwF77e5Vd2N"  //秘钥

#define   TOPIC         "environmentData"      //订阅的主题
